...
function pageSearch() {
	...
	$.ajax({
		type: 'POST',
		url: '/ps/ps_ran/hand_over/x2_out/search',
...
function excel_download(){
	...
	var url =  "/ps/excelDown?PAGE=X2OUT&HEADERS="+headers+"&COLUMNS="+columns+
			...
			"&TYPE="+searchInfo.TYPE +"&TCID="+searchInfo.TCID +"&HOCAUSE="+searchInfo.HOCAUSE+"&TITLE=HAND-OVER_X2-OUT_통계" + 
