...
function pageSearch() {
	...
	$.ajax({
		type: 'POST',
		url: '/ps/ps_epc/ps_sgw/ps_sgw_ho/sgw_bd/search',
...
function getlength(){
	...
	$.ajax({
		...
		success: function (data) {
			   totalcount = data.sgwBdInfoLength.length <= 0?0:data.sgwBdInfoLength[0].TOT_CNT;
...
function excel_download(){
		...
		var url =  "/ps/excelDown?PAGE=SGWBD&HEADERS="+headers+"&COLUMNS="+columns+
