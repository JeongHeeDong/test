...
function pageSearch() {
	...
	$.ajax({
		type: 'POST',
		url: '/ps/ps_epc/ps_pgw/ps_pgw_ho/pgw_bm/search',
...
function getlength(){
	...
	$.ajax({
		...
		success: function (data) {
			   totalcount = data.pgwBmInfoLength.length <= 0?0:data.pgwBmInfoLength[0].TOT_CNT;
...
function excel_download(){
		...
		var url =  "/ps/excelDown?PAGE=PGWBM&HEADERS="+headers+"&COLUMNS="+columns+
