...
function pageSearch() {
	...
	$.ajax({
		type: 'POST',
		url: '/ps/ps_epc/ps_pgw/ps_pgw_ho/pgw_ba/search',
...
function getlength(){
	...
	$.ajax({
		...
		success: function (data) {
			   totalcount = data.pgwBaInfoLength.length <= 0?0:data.pgwBaInfoLength[0].TOT_CNT;
...
function excel_download(){
		...
		var url =  "/ps/excelDown?PAGE=PGWBA&HEADERS="+headers+"&COLUMNS="+columns+
