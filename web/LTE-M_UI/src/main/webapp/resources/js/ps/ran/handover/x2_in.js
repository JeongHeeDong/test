...
function pageSearch() {
	...
	$.ajax({
		type: 'POST',
		url: '/ps/ps_ran/hand_over/x2_in/search',
...
function excel_download(){
	...
	var url =  "/ps/excelDown?PAGE=X2IN&HEADERS="+headers+"&COLUMNS="+columns+
			...
			"&TYPE="+searchInfo.TYPE +"&HOCAUSE="+searchInfo.HOCAUSE+"&TITLE=HAND-OVER_X2-IN_통계" + 
