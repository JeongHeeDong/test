...
//				}
			...
			$.each(lineInfoData ,function(idx, lineinfo){
				if(lineinfo.LINE_ID != '0'){
					...
					srcIdx = idx
					$('#LINE_ID_POP').append('<li data-id='+lineInfoData[srcIdx].LINE_ID+'>'+lineInfoData[srcIdx].LINE_NAME+'</li>');
...
function stationModifyView(){
	...
	$('#STATION_TYPE_NM').text(data['STATION_TYPE_NAME']);
