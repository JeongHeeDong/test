...
<head>
    ...
    <script src="<c:url value="/resources/js/ps/ran/handover/intra_enb.js"><c:param name="version" value="${nowDate}"/></c:url>"></script>
...
<!-- 													<input type="radio" id="r4" name="search_time" value="time"> -->
										...
										<td>
											<div class="mu-vgroup">
												<div class="mu-checkbox">
													<input id="search_chk_tcid" type="checkbox">
													<label for="search_chk_tcid">TCID</label>
												</div>
												<div class="mu-checkbox">
                        ...
                        <table class="mu-grid mu-grid-border mu-grid-strip mu-grid-sort2" id='grid_handover'>
							<thead>
								<tr id="headerTr">
										...
										<th class="updown sort" id="TCID">TCID</th>
