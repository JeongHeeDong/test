...
<head>
	...
	<script src="/resources/js/pm/record/analysis/record_analysis.js"></script>
			...
			<div class="mu-search-group mu-more-item">
				<div class="mu-search-item">
					<div class="mu-item-group">
						...
						<button type="button" class="mu-btn" onclick="javascript:equipSelectView(2, null, '10')">장비선택</button>
						<span class="lineY">
							<label>지표</label>
				...
				<div class="mu-search-btn">
					<table>
						...
						<tr>
							<td>
								<button type="button" class="mu-btn mu-btn-icon mu-btn-search" onclick="javascript:getRecordTrendData(false)" style="margin: 5px 5px 5px 5px;"><i class="mu-icon search"></i>검색</button>
							</td>
						</tr>
						<tr>
							<td>
				...
				<table class="mu-grid mu-grid-border mu-grid-strip mu-grid-sort2">
					...
					<thead>
						<tr id="headerTr">
							...
							<th class="updown sort">이전 시도호</th>
