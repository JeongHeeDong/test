			...
			<div class="mu-search-group">
				<div class="mu-search-item">
					...
					<div class="mu-item-group">
						...
						<div class="mu-radio">
							<input type="radio" id="r2" name="search_col" value="config" onclick="optionSearch()">
							<label for="r2">구성</label>
						</div>
						<div class="mu-radio">
							<input type="radio" id="r3" name="search_col" value="perform"  checked="checked" onclick="optionSearch()">
