		...
		<section>
			...
			<div class="nwTopologyWrap">
				<div class="nwTopology fr">
					...
					<div class="timeWrap">감시시간 : 2017/01/01 00:00</div>
...
<%--
    2022.05.13
    스마트 항공기지, P168함 등 프로젝트 별 스타일 분기 처리
--%>
<c:set var = "equipSizeStyle" value="" />    
<c:choose>
    <c:when test="${'P168' eq projectProfile}">
        <c:set var = "equipSizeStyle" value="more-type" />
    </c:when>
    <c:otherwise>
        <c:set var = "equipSizeStyle" value="lg-type" />
    </c:otherwise>
</c:choose>     
    
			<!-- Topology -->
			<div class="${projectProfile} topologyWrap">
				<div class="mu-row">
					<div class="mu-col mu-col-4">
						<div class="server-wrap">
							<div class="tit">EPC</div>
							<div class="server-area epc ${ equipSizeStyle }" id="epcList">
								<!-- MME -->
								<div class="serverGroup double mme">
									<span class="stage" style="display:none;"></span>
									<div id="equip_MME00b_1_S" class="serverBox server01">
										<div class="state normalgray"></div>
										<strong class="tit"></strong>
									</div>
									<div id="equip_MME00a_1_A" class="serverBox server02">
								...
								<div class="serverGroup double gw">
									<span class="stage" style="display:none;"></span>
									<div id="equip_SPGW00b_4_S" class="serverBox server01">
										<div class="state normalgray"></div>
										<strong class="tit"></strong>
									</div>
									<div id="equip_SPGW00a_4_A" class="serverBox server02">
										<div class="state normalblue"></div>
										<strong class="tit"></strong>
									</div>
									<div class="engineer" style="display:none;"></div>
								...
								<div class="serverGroup double hss">
									<span class="stage" style="display:none;"></span>
									<div id="equip_HPS00b_6_S" class="serverBox server01">
										<div class="state normalgray"></div>
										<strong class="tit"></strong>
									</div>
									<div id="equip_HPS00a_6_A" class="serverBox server02">
										<div class="state normalblue"></div>
										<strong class="tit"></strong>
									</div>
									<div class="engineer" style="display:none;"></div>
					...
					<div class="mu-col mu-col-5">
						<div class="server-wrap">
							...
							<div class="server-area etc ${ equipSizeStyle }" id="etcList">
								<!-- 스위치 1 -->
								<div class="serverGroup">
									<span class="stage" style="display:none;"></span>
									<div id="equip_1181_57_A" class="serverBox">
										<div class="state normalblue"></div>
										<strong class="tit"></strong>
									</div>
									<div class="engineer" style="display:none;"></div>
								...
								<div class="serverGroup">
									<span class="stage" style="display:none;"></span>
									<div id="equip_1182_57_A" class="serverBox">
										<div class="state normalblue"></div>
										<strong class="tit"></strong>
									</div>
									<div class="engineer" style="display:none;"></div>
								...
								<div class="serverGroup">
									<span class="stage" style="display:none;"></span>
									<div id="equip_1183_57_A" class="serverBox">
										<div class="state normalblue"></div>
										<strong class="tit"></strong>
									</div>
									<div class="engineer" style="display:none;"></div>
								...
								<div class="serverGroup">
									<span class="stage" style="display:none;"></span>
									<div id="equip_1184_57_A" class="serverBox">
										<div class="state normalblue"></div>
										<strong class="tit"></strong>
									</div>
									<div class="engineer" style="display:none;"></div>
								...
								<c:if test="${'P168' eq projectProfile}">
                                    <!-- 스위치 5 -->
	                                <div class="serverGroup">
	                                    <span class="stage" style="display:none;"></span>
	                                    <div id="equip_1185_57_A" class="serverBox">
	                                        <div class="state normalblue"></div>
	                                        <strong class="tit"></strong>
	                                    </div>
	                                    <div class="engineer" style="display:none;"></div>
	                                ...
	                                <div class="serverGroup">
	                                    <span class="stage" style="display:none;"></span>
	                                    <div id="equip_1186_57_A" class="serverBox">
	                                        <div class="state normalblue"></div>
	                                        <strong class="tit"></strong>
	                                    </div>
	                                    <div class="engineer" style="display:none;"></div>
	                                ...
	                                <div class="serverGroup">
	                                    <span class="stage" style="display:none;"></span>
	                                    <div id="equip_1187_57_A" class="serverBox">
	                                        <div class="state normalblue"></div>
	                                        <strong class="tit"></strong>
	                                    </div>
	                                    <div class="engineer" style="display:none;"></div>
					...
					<c:if test="${'P168' ne projectProfile}">
						<div class="mu-col mu-col-3">
							<div class="server-wrap">
								<div class="tit">EMS</div>
								<div class="server-area ems ${ equipSizeStyle }" id="emsList">
									<div class="serverGroup double ems-c">
										<span class="stage" style="display:none;"></span>
										<div id="equip_EMS00b_15_S" class="serverBox server01">
											<div class="state normalblue"></div>
											<strong class="tit"></strong>
										</div>
										<div id="equip_EMS00a_15_A" class="serverBox server02">
											<div class="state normalblue"></div>
											<strong class="tit"></strong>
										</div>
										<div class="engineer" style="display:none;"></div>
									...
									<!-- EMS-R -->
									<div class="serverGroup double ems-r">
										<span class="stage" style="display:none;"></span>
										<div id="equip_GSMS00b_38_S" class="serverBox server01">
											<div class="state normalblue"></div>
											<strong class="tit"></strong>
										</div>
										<div id="equip_GSMS00a_38_A" class="serverBox server02">
											<div class="state normalblue"></div>
											<strong class="tit"></strong>
										</div>
										<div class="engineer" style="display:none;"></div>
				...
				<div class="mu-row">
                    <div class="mu-col mu-col-12 <c:if test="${'P168' eq projectProfile}">mu-col-10</c:if>">  				
						<div class="server-wrap">
							<div class="tit">서비스<br>서버</div>
							<div class="server-area service-server ${ equipSizeStyle }" id="serviceServerList">
							    <!-- MCPTT -->
								<div class="serverGroup <c:if test="${'P168' eq projectProfile}">double</c:if>">
									<span class="stage" style="display:none;"></span>
-<c:choose>
    <c:when test="${'P168' eq projectProfile}">
                                    <div id="equip_1111_9_A" class="serverBox server01">
                                        <div class="state normalblue"></div>
                                        <strong class="tit"></strong>
                                    </div> 
                                    <div id="equip_1111_9_B" class="serverBox server02">
                                        <div class="state normalblue"></div>
                                        <strong class="tit"></strong>
                                    </div> 
    </c:when>
    <c:otherwise>
								...
								<!-- call -->
								<div class="serverGroup message <c:if test="${'P168' eq projectProfile}">double</c:if>" <c:if test="${'P168' eq projectProfile}">style="margin-left:70px;"</c:if>>
									<span class="stage" style="display:none;"></span>
-<c:choose>
    <c:when test="${'P168' eq projectProfile}">
                                    <div id="equip_1121_8_A" class="serverBox server01">
                                        <div class="state normalblue"></div>
                                        <strong class="tit"></strong>
                                    </div>    
                                    <div id="equip_1121_8_B" class="serverBox server02">
                                        <div class="state normalblue"></div>
                                        <strong class="tit"></strong>
                                    </div>    
    </c:when>
    <c:otherwise>
								...
								<!-- 음성영상서버 -->
								<div class="serverGroup ucms" <c:if test="${'P168' eq projectProfile}">style="margin-left:70px;"</c:if>>
									<span class="stage" style="display:none;"></span>
								...
								<!-- 영상중계서버 -->
								<div class="serverGroup backup" <c:if test="${'P168' eq projectProfile}">style="margin-left:70px;"</c:if>>
									<span class="stage" style="display:none;"></span>
								...
								<!--  GIS서버 -->
								<c:if test="${empty projectProfile}"> <%-- 스마트쉽 제외 : 2022.06기준 스마트항공기지 적용 --%>
								...
								<!-- IOT서버 -->
								<div class="serverGroup positioning" <c:if test="${'P168' eq projectProfile}">style="margin-left:70px;"</c:if>>
									<span class="stage" style="display:none;"></span>
								...
								<!-- UTM -->
								<div class="serverGroup double firewall" <c:if test="${'P168' eq projectProfile}">style="margin-left:70px;"</c:if>>
									<span class="stage" style="display:none;"></span>
								...
								<c:if test="${empty projectProfile}"> <%-- 스마트쉽 제외 : 2022.06기준 스마트항공기지 적용 --%>
									<div class="serverGroup positioning ">
										<span class="stage" style="display:none;"></span>
										<div id="equip_1191_58_A" class="serverBox">
											<div class="state normalblue"></div>
											<strong class="tit"></strong>
										</div>
										<div class="engineer" style="display:none;"></div>
                        ...
                        <div class="mu-col mu-col-3">
                            <div class="server-wrap">
                                ...
                                <div class="server-area ems ${ equipSizeStyle }" id="emsList">
                                    ...
                                    <!-- EMS-R -->
                                    <div class="serverGroup double ems-r" <c:if test="${'P168' eq projectProfile}">style="margin-left:70px;"</c:if>>
                                        <span class="stage" style="display:none;"></span>
                                        <div id="equip_GSMS00b_38_S" class="serverBox server01">
                                            <div class="state normalblue"></div>
                                            <strong class="tit"></strong>
				...
				<div class="mu-row">
					<div class="mu-col mu-col-12">
						<!--아래의 클래스에서 duServer-all 마지막 all을 5,6,7,8 로 바꾸면 해당 라인의 번호로 배경색상을 바꿔준다. -->
						<div class="server-wrap ${ projectProfile }">
							<div class="tit">기지국</div>
							<div class="server-area base-station ${ equipSizeStyle }" id="duList">
								<!-- <div id="duList">
								</div> -->
							</div>
						</div>
