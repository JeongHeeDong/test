...
<head>
	...
	<script src="/resources/js/pss/epc/hssEms/hssEmsSearch.js"></script>
</head>
<body>
	...
	<div class="mu-container">
					...
					<div class="mu-search-group"><!-- // 다단 검색폼을 사용할 경우 해당 태그에  mu-more-item  클래스를 추가해주시면 됩니다. -->
						<div class="mu-search-item">
							<div class="mu-item-group">
								<label>HSS-EMS Name</label>
								<input id="hssEms_nm_value" type="text" class="mu-input">
							</div>
						</div><!-- //mu-search-item -->
						<div class="mu-search-btn">
							...
							<button type="button" class="mu-btn mu-btn-icon" onclick="javascript:hssEmsAddView()"><i class="mu-icon add"></i>추가</button>
						</div>
					</div><!-- //mu-search-group -->
				</div>
			</div>
		...
		<%@ include file="/WEB-INF/views/pss/epc/hssEms/hssEmsDetail.jsp" %>
		<%@ include file="/WEB-INF/views/pss/epc/hssEms/hssEmsAdd.jsp" %>
