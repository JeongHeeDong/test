...
<head>
	...
	<script src="/resources/js/pss/ems/emsSearch.js"></script>
</head>
<body>
	...
	<div class="mu-container">
					...
					<div class="mu-search-group"><!-- // 다단 검색폼을 사용할 경우 해당 태그에  mu-more-item  클래스를 추가해주시면 됩니다. -->
						<div class="mu-search-item">
							<div class="mu-item-group">
								...
								<input id="ems_nm_value" type="text" class="mu-input">
								<label>EMS 타입</label>
								<div class="mu-selectbox">
			                        <select id="emsSelect" class="mu-value" >
						...
						<div class="mu-search-btn">
							...
							<button type="button" class="mu-btn mu-btn-icon" onclick="javascript:emsAddView()"><i class="mu-icon add"></i>추가</button>
							<span class="lineY">
							 	<div class="mu-selectbox">
			...
			<div class="mu-row">
				<div class="mu-col mu-col-12">
					...
					<div class="gridWrap mt10" style="overflow:auto;max-height:691px">
						<table id='table' class="mu-grid mu-grid-border mu-grid-strip mu-grid-number mu-grid-hover">
							<thead>
								<tr>
									<th>NO</th>
									<th>EMS ID</th>
		...
		<%@ include file="/WEB-INF/views/pss/ems/emsDetail.jsp" %>
		<%@ include file="/WEB-INF/views/pss/ems/emsAdd.jsp" %>
