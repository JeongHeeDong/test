...
<head>
	...
	<script src="/resources/js/pss/epc/epcSearch.js"></script>
</head>
<body>
	...
	<div class="mu-container">
					...
					<div class="mu-search-group"><!-- // 다단 검색폼을 사용할 경우 해당 태그에  mu-more-item  클래스를 추가해주시면 됩니다. -->
						<div class="mu-search-item">
							<div class="mu-item-group">
								<label>장비명</label>
								<input id="epc_nm_value" type="text" class="mu-input">
							</div>
						</div><!-- //mu-search-item -->
						<div class="mu-search-btn">
							...
							<button type="button" class="mu-btn mu-btn-icon" onclick="javascript:epcAddView()"><i class="mu-icon add"></i>추가</button>
							<span class="lineY">
		...
		<%@ include file="/WEB-INF/views/pss/epc/mme/mmeDetail.jsp" %>
		<%@ include file="/WEB-INF/views/pss/epc/pgw/pgwDetail.jsp" %>
		<%@ include file="/WEB-INF/views/pss/epc/hss/hssDetail.jsp" %>
		<%@ include file="/WEB-INF/views/pss/epc/pcrf/pcrfDetail.jsp" %>
		<%@ include file="/WEB-INF/views/pss/epc/epcAdd.jsp" %>
