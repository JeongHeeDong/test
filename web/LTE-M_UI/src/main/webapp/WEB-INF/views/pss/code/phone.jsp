...
<head>
	...
	<script src="<c:url value="/resources/js/pss/code/phone.js"><c:param name="version" value="${nowDate}"/></c:url>"></script>
</head>
<body>
				...
				<div class="mu-search-item">
					<div class="mu-item-group">
						...
						<div class="mu-selectbox">
							<button id="searchOpt_btn" class="mu-value" style="width:150px">선택</button>
						...
						<table id="phoneTable" class="mu-grid mu-grid-border mu-grid-strip" >
							<thead>
								<tr>
									...
									<th style="width:400px" id="USE_CODE"><span class="th_val">단말그룹 CODE</span></th>
									<th id="USE_CODE_NAME"><span class="th_val">단말그룹 CODE명</span></th>
								</tr>
							</thead>
							<tbody id="phoneGrid">		
							</tbody>
	...
	<div id="phoneAddUp" class="mu-dialog mu-fix-foot" style="display: none; width: 530px; height: 220px; left: 42%; top: 25%;z-index: 11"><!-- resize 부분 -->
		<div id="phoneAddTitleBox" class="mu-dialog-head" ><!-- 창 이동 부분 -->
			<h2><span class="title">단말그룹 CODE 추가</span></h2>
		...
		<div class="mu-dialog-body">
			<table class="mu-formbox">
				...
				<tbody>
					<tr>
						<th><label>단말그룹 CODE</label></th>
						<td>
							<input type="number" name="USE_CODE" class="mu-input"/>
						</td>
					</tr>
					<tr>
						<th><label>단말그룹 CODE명</label></th>
						<td>
							<input type="text" name="USE_CODE_NAME" class="mu-input"/>
						</td>
					</tr>
				</tbody>
			</table>
