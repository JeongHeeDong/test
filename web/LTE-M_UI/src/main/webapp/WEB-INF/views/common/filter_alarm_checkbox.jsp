...
<script src="/resources/js/filter_alarm/filter_alarm_checkbox.js"></script>
		        ...
		        <table>
		            <tbody>
			            <tr>
			            	<td>
				                <div class="mu-checkbox">
							        <input type="checkbox" name="alarmCheckbox" id = "all" value= 4>
			            ...
			            <tr>
			            	<td>
				                <div class="mu-checkbox">
							        <input type="checkbox" name="alarmCheckbox" id = "cri" value= 1>
							        <label for="cri">Critical</label>
							    </div>
		                    </td>
			            </tr>
			            <tr>
			            	<td>
				                <div class="mu-checkbox">
							        <input type="checkbox" name="alarmCheckbox" id = "maj" value= 2>
			            ...
			            <tr>
			            	<td>
				                <div class="mu-checkbox">
							        <input type="checkbox" name="alarmCheckbox" id = "min" value= 3>
							        <label for="min">Minor</label>
							    </div>
		                    </td>
			            </tr>
		        	</tbody>
